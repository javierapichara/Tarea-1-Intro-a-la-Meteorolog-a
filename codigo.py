...
ax4.set_title('Serie de tiempo de Temperatura del Viento en estación Parque OHiggins')
ax4.grid()
...
ax10.set_title('Ciclo Diario de Temperatura del Viento en estación Parque OHiggins')
ax10.grid()
...
ax15.set_title('Ciclo Estacional de Temperatura del Viento en estación Parque OHiggins')
ax15.grid()
...
ax6.text(20, 0.045, textstr
    , fontsize=10, va='bottom')
ax6.set_title('Histograma Temperatura del Viento en estación Parque OHiggins')
...
ax13.set_title('Diagrama Mes-Hora Temperatura del Viento en estación Parque OHiggins')
